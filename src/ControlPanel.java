...
public class ControlPanel extends JPanel {
    ...
    private static final Color ACCENT_BLUE = new Color(61, 133, 198); // River blue
    private static final Color TEXT_PRIMARY = new Color(245, 247, 242); // Off-white
    ...
    public ControlPanel(MazePanel mazePanel) {
        ...
        setPreferredSize(new Dimension(350, 500)); // Slightly wider untuk dropdown
    ...
    /**
     * Main controls: dropdown + buttons
     */
    ...
    /**
     * Dropdown untuk pilih algoritma
     */
    private JPanel createAlgorithmSelectorPanel() {
        ...
        // Set size yang pas dan centered
    ...
    /**
     * Action buttons: Run & Compare - FULL WIDTH & ALIGNED
     */
    ...
    /**
     * Modern button with rounded style
     */
    ...
    /**
     * Legend panel dengan design yang lebih compact
     */
    ...
    private JPanel createResultsPanel() {
        ...
        resultArea = new JTextArea(9, 25); // Slightly smaller
    ...
    /**
     * Display hasil satu algoritma dengan detail
     */
    ...
    /**
     * Compare semua algoritma dengan detailed analysis
     */
